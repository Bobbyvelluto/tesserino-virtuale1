...
def main(_):
    ...
    model = keras.layers.TFSMLayer(FLAGS.ckpt_path, call_endpoint='serving_default')
    ...
    def _process_file(i):
        ...
        input_img = tf.image.resize(input_img, (256, 256)).numpy()
        ...
        # handle multi-stage outputs, ottieni l'output dal layer
